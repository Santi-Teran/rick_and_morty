    ...
    return (
        <nav className={style.container}>
            ...
            <div className={style.navLinksContainer}>
                ...
                <NavLink to ="/portfolio" className={style.navLink}>Portfolio</NavLink>
            ...
            <div className={`${style.dropDownMenu} ${isOpen ? style.open : ''}`}>
                <NavLink to ="/home" className={style.navMenu}>Home</NavLink>
                <NavLink to ="/about" className={style.navMenu}>About</NavLink>
                <NavLink to ="/favorites" className={style.navMenu}>Favorites</NavLink>
                <NavLink to ="/portfolio" className={style.navMenu}>Portfolio</NavLink>
